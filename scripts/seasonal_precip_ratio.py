...
obs_nc = netCDF4.Dataset(
    "bcsd3/sresa1b.miroc3_2_medres.1.monthly.Prcp.1950-2099.nc"
)
...
jan = numpy.average(
    obs_nc.variables["Prcp"][offset1 + 0 : offset2 : 12, :, :], 0
)
feb = numpy.average(
    obs_nc.variables["Prcp"][offset1 + 1 : offset2 : 12, :, :], 0
)
dec = numpy.average(
    obs_nc.variables["Prcp"][offset1 + 11 : offset2 : 12, :, :], 0
)
obs = (jan + feb + dec) / 3.0

jan = numpy.average(
    obs_nc.variables["Prcp"][offset3 + 0 : offset4 : 12, :, :], 0
)
feb = numpy.average(
    obs_nc.variables["Prcp"][offset3 + 1 : offset4 : 12, :, :], 0
)
dec = numpy.average(
    obs_nc.variables["Prcp"][offset3 + 11 : offset4 : 12, :, :], 0
)
fut = (jan + feb + dec) / 3.0
...
m.pcolormesh(
    x, y, ratio, numpy.arange(0, 2.5, 0.1), latlon=True, units="ratio"
)
