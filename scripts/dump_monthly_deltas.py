...
p_obs_nc = netCDF4.Dataset('bcsd3/sresa1b.miroc3_2_medres.1.monthly.Prcp.1950-2099.nc')
p_fut_nc = netCDF4.Dataset('bcsd3/sresa1b.miroc3_2_medres.1.monthly.Prcp.1950-2099.nc')
...
output = open('monthly_deltas.csv', 'w')
