...
obs = numpy.average(obs_nc.variables["Prcp"][offset1:offset2, :, :], 0)
fut = numpy.average(fut_nc.variables["Prcp"][offset3:offset4, :, :], 0)
...
m = MapPlot(
    ...
    caption="",
    nologo=True,
    title=r"MIROC3.2 exp1 BCSD Annual Precipitation Ratio A1B / C20",
...
m.postprocess(filename="annual_ratio_bcsd_miroc_only.png")
