...
a1b_mar_td = (243.5 * np.log10(a1b_mar) - 440.8) / (19.48 - np.log10(a1b_mar))
a1b_apr_td = (243.5 * np.log10(a1b_apr) - 440.8) / (19.48 - np.log10(a1b_apr))
a1b_may_td = (243.5 * np.log10(a1b_may) - 440.8) / (19.48 - np.log10(a1b_may))
a1b_jun_td = (243.5 * np.log10(a1b_jun) - 440.8) / (19.48 - np.log10(a1b_jun))
a1b_jul_td = (243.5 * np.log10(a1b_jul) - 440.8) / (19.48 - np.log10(a1b_jul))
a1b_aug_td = (243.5 * np.log10(a1b_aug) - 440.8) / (19.48 - np.log10(a1b_aug))
a1b_sep_td = (243.5 * np.log10(a1b_sep) - 440.8) / (19.48 - np.log10(a1b_sep))
a1b_oct_td = (243.5 * np.log10(a1b_oct) - 440.8) / (19.48 - np.log10(a1b_oct))
a1b_nov_td = (243.5 * np.log10(a1b_nov) - 440.8) / (19.48 - np.log10(a1b_nov))
a1b_dec_td = (243.5 * np.log10(a1b_dec) - 440.8) / (19.48 - np.log10(a1b_dec))

c20_jan_td = (243.5 * np.log10(c20_jan) - 440.8) / (19.48 - np.log10(c20_jan))
c20_feb_td = (243.5 * np.log10(c20_feb) - 440.8) / (19.48 - np.log10(c20_feb))
c20_mar_td = (243.5 * np.log10(c20_mar) - 440.8) / (19.48 - np.log10(c20_mar))
c20_apr_td = (243.5 * np.log10(c20_apr) - 440.8) / (19.48 - np.log10(c20_apr))
c20_may_td = (243.5 * np.log10(c20_may) - 440.8) / (19.48 - np.log10(c20_may))
c20_jun_td = (243.5 * np.log10(c20_jun) - 440.8) / (19.48 - np.log10(c20_jun))
c20_jul_td = (243.5 * np.log10(c20_jul) - 440.8) / (19.48 - np.log10(c20_jul))
c20_aug_td = (243.5 * np.log10(c20_aug) - 440.8) / (19.48 - np.log10(c20_aug))
c20_sep_td = (243.5 * np.log10(c20_sep) - 440.8) / (19.48 - np.log10(c20_sep))
c20_oct_td = (243.5 * np.log10(c20_oct) - 440.8) / (19.48 - np.log10(c20_oct))
c20_nov_td = (243.5 * np.log10(c20_nov) - 440.8) / (19.48 - np.log10(c20_nov))
c20_dec_td = (243.5 * np.log10(c20_dec) - 440.8) / (19.48 - np.log10(c20_dec))
