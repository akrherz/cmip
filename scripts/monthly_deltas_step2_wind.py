...
jan = numpy.average(wnd_a1b[::12, :, :], 0) - numpy.average(
    wnd_20c[::12, :, :], 0
)
feb = numpy.average(wnd_a1b[1::12, :, :], 0) - numpy.average(
    wnd_20c[1::12, :, :], 0
)
mar = numpy.average(wnd_a1b[2::12, :, :], 0) - numpy.average(
    wnd_20c[2::12, :, :], 0
)
apr = numpy.average(wnd_a1b[3::12, :, :], 0) - numpy.average(
    wnd_20c[3::12, :, :], 0
)
may = numpy.average(wnd_a1b[4::12, :, :], 0) - numpy.average(
    wnd_20c[4::12, :, :], 0
)
jun = numpy.average(wnd_a1b[5::12, :, :], 0) - numpy.average(
    wnd_20c[5::12, :, :], 0
)
jul = numpy.average(wnd_a1b[6::12, :, :], 0) - numpy.average(
    wnd_20c[6::12, :, :], 0
)
aug = numpy.average(wnd_a1b[7::12, :, :], 0) - numpy.average(
    wnd_20c[7::12, :, :], 0
)
sep = numpy.average(wnd_a1b[8::12, :, :], 0) - numpy.average(
    wnd_20c[8::12, :, :], 0
)
october = numpy.average(wnd_a1b[9::12, :, :], 0) - numpy.average(
    wnd_20c[9::12, :, :], 0
)
nov = numpy.average(wnd_a1b[10::12, :, :], 0) - numpy.average(
    wnd_20c[10::12, :, :], 0
)
dec = numpy.average(wnd_a1b[11::12, :, :], 0) - numpy.average(
    wnd_20c[11::12, :, :], 0
)
