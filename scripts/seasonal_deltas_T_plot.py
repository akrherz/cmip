...
obs_nc = netCDF4.Dataset('bcsd3/sresa1b.miroc3_2_medres.1.monthly.Tavg.1950-2099.nc')
fut_nc = netCDF4.Dataset('bcsd3/sresa1b.miroc3_2_medres.1.monthly.Tavg.1950-2099.nc')
...
jan = numpy.average(obs_nc.variables['Tavg'][offset1+5:offset2:12,:,:],0)
feb = numpy.average(obs_nc.variables['Tavg'][offset1+6:offset2:12,:,:],0)
dec = numpy.average(obs_nc.variables['Tavg'][offset1+7:offset2:12,:,:],0)
obs = (jan + feb + dec)/3.0

jan = numpy.average(obs_nc.variables['Tavg'][offset3+5:offset4:12,:,:],0)
feb = numpy.average(obs_nc.variables['Tavg'][offset3+6:offset4:12,:,:],0)
dec = numpy.average(obs_nc.variables['Tavg'][offset3+7:offset4:12,:,:],0)
fut = (jan + feb + dec)/3.0
...
m.pcolormesh(x, y, ratio, numpy.arange(-8,8.1,1), latlon=True, units=r"$^\circ$C")
