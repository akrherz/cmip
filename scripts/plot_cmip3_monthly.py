...
hussnc = netCDF4.Dataset(
    "../miroc3_2_medres/pcmdi.ipcc4.miroc3_2_medres.sresa1b.run1.monthly.huss_A1.nc"
)
nc = netCDF4.Dataset(
    "../miroc3_2_medres/pcmdi.ipcc4.miroc3_2_medres.sresa1b.run1.monthly.ps_A1.nc"
)
...
hussdata = np.average(
    hussnc.variables["huss"][idx1 + 5 : idx2 + 1 : 12, :, :], 0
)
...
m.pcolormesh(lons, lats, td, np.linspace(0, 30, 12), clip_on=False)
